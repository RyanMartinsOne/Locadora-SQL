...
idLocacao INT NOT NULL,
idVeiculo INT NOT NULL,
CONSTRAINT pkLocacaoVeiculo PRIMARY KEY (idLocacao, idVeiculo),
CONSTRAINT fkLocacaoVeiculoAssociativa FOREIGN KEY (idLocacao) REFERENCES Locacao(idLocacao),
CONSTRAINT fkVeiculoLocacaoAssociativa FOREIGN KEY (idVeiculo) REFERENCES Veiculo(idVeiculo)
);
...
CREATE TABLE Manutencao (
    ...
    CONSTRAINT pkManutencao PRIMARY KEY (idManutencao),
